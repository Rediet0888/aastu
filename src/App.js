    ...
    <Route path='/' component={ <LoginForm/>}></Route>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route
            path="/AdminStudent/Notification"
            element={
              <Layout>
                {' '}
                <NotificationOfStudentAdmin />
              </Layout>
            }
          ></Route>
          <Route
            path="/AdminEmployee/ScheduleHearing"
            element={
              <Layout>
                {' '}
                <ScheduleHearing />{' '}
          ...
          ></Route>
          <Route
            path="/AdminStudent/AddScholarshipNews"
            element={
              <Layout>
                {' '}
                <AddScholarshipNews />{' '}
          ...
          ></Route>
          <Route
            path="/AdminStudent/RulesandRegulation"
            element={
              <Layout>
                {' '}
                <Profile />{' '}
          ...
          ></Route>
          <Route
            path="/AdminEmployee/Notification"
            element={
              <Layout>
                {' '}
                <NotificationOfEmployeeAdmin />{' '}
              </Layout>
            }
          ></Route>
          <Route
          ...
          ></Route>
          <Route
            path="/AdminEmployee/AddPrefermentNews"
            element={
              <Layout>
                {' '}
                <AddPrefermentNews />
          ...
          ></Route>
          <Route
            path="/AdminEmployee/RulesandRegulation"
            element={
              <Layout>
                {' '}
                <Profile />{' '}
        ...
        <Route path='/r' element={ <Layout> <Layout/></Layout>}></Route> */}
          ...
          ></Route>
          <Route
            path="/Employee/CreateAccusation"
            element={
              <Layout>
                {' '}
                <IncidentRegForm />
