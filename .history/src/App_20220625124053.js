...
import RulesAndRegulation from '../src/data/files/Rules and Regulation for student';
    ...
    <BrowserRouter>
      ...
      <Routes>
       ...
       <Route path='/AdminEmployee/AddPrefermentNews' element={ <Layout> <AddPrefermentNews/></Layout>}></Route>
        ...
        <Route path='/RulesAndRegulation' element={ <Layout> <RulesAndRegulation/></Layout>}></Route>
