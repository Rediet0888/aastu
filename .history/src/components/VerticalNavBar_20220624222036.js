...
export default function VerticalNavBar(props) {
  ...
  const handleDrawerClose = () => {
    ...
    { id: 4, name: 'Schedule Hearing', icon: AccessTimeIcon , path:"/ScheduleHearing"},
    { id: 5, name: 'Add Scholarship News', icon: NoteAddIcon , path:"/AddScholarshipNews"},
    { id: 6, name: 'Rules & Regulation', icon: DescriptionIcon , path:"/StudentDashboard"},
    { id: 7,name: 'Create Accusation', icon: NoteAddIcon , path:"/IncidentRegForm"},
    { id: 8,name: 'Add Preferment News', icon: NoteAddIcon , path:"/AddPrefermentNews"},
