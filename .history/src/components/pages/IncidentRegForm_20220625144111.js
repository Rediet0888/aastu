     ...
     <Grid >
      ...
      <h1> Incidents Registration Form</h1>
        ...
        {/* <TextField id="outlined-basic" label="Accusor Id" variant="outlined" /><br /><br /> */}
         <TextField size='small' id="outlined-basic" variant="outlined"  onChange={e => {
      ...
      value={accuser}  />
       ...
       <TextField id="outlined-basic" size='small' variant="outlined"  onChange={e => {
    ...
    <Grid className='div'>
      ...
      value={casetype}  />
        ...
        <input type="file" onChange={onChange} accept="application/pdf"/>
              ...
              <a download="download.pdf" href={pdfData} title='Download pdf document' >Open File</a>
       ...
       <Divider variant="middle" />
         ...
         <Divider variant="middle" /> */}
           ...
           {/* {witness.map((i) => { */}
             ...
             <TextField id="standard-basic" size='small' variant="outlined"  
              onChange={e => {
