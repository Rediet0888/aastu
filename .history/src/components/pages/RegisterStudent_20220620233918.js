    ...
    <Grid>
        <Paper elevation={20} style={regse}>
            ...
            <Grid xs={12} className='regname'>
                ...
                <TextField id="outlined-basic" label="FirstName" error={Boolean(firstNameErrors?.firstname)}  helperText={firstNameErrors?.firstname} variant="outlined" onChange={e => {
                ...
                <TextField id="outlined-basic" label="MiddleName" error={Boolean(middleNameErrors?.middlename)}  helperText={middleNameErrors?.middlename} variant="outlined" onChange={e => {
                ...
                <TextField id="outlined-basic" label="LastName" error={Boolean(lastNameErrors?.lastname)}  helperText={lastNameErrors?.lastname} variant="outlined" onChange={e => {
       ...
       <Divider variant="middle" />
            ...
            <Grid xs={4} >
                ...
                <TextField id="outlined-basic" label="Email" error={Boolean(emailErrors?.email)}  helperText={emailErrors?.email} variant="outlined" onChange={e => {
            ...
            <Grid xs={4} >
                ...
                <TextField id="outlined-basic" label="Password" error={Boolean(passwordErrors?.password)}  helperText={passwordErrors?.password}  variant="outlined" onChange={e => {
                ...
                <TextField id="outlined-basic" label="PhoneNo" error={Boolean(phoneNoErrors?.phoneno)}  helperText={phoneNoErrors?.phoneno} variant="outlined" onChange={e => {
      ...
      />
       ...
       <Divider variant="middle" />
            ...
            <Grid xs={4} >
                ...
                <TextField id="outlined-basic" label="City" error={Boolean(cityErrors?.city)}  helperText={cityErrors?.city} variant="outlined" onChange={e => {
       ...
       <Divider variant="middle" />
            ...
            <Grid xs={6} >
                ...
                <TextField id="outlined-basic" label="FullName" error={Boolean(fullNameErrors?.fullname)}  helperText={fullNameErrors?.fullname} variant="outlined" onChange={e => {
            ...
            <Grid xs={6} >
                <Typography>Phone Number</Typography>
                <TextField id="outlined-basic" label="Emergency Contact Phone Number" error={Boolean(phoneNoErrors?.phoneno)}  helperText={phoneNoErrors?.phoneno} variant="outlined" onChange={e => {
                      setEmergencyPhoneNo(e.target.value)
                    }}
      ...
      />
            ...
            <Grid xs={4} >
                ...
                <TextField id="outlined-basic" label="Block" variant="outlined" value={block} />
            </Grid> 
            <Grid xs={4} >
                <Typography>Dorm</Typography>
                <TextField id="outlined-basic" label="Dorm" variant="outlined" value={dorm} />
            </Grid> 
       </Grid>
       ...
       <TextField id="outlined-basic" label="Year" variant="outlined" value={year}/>
            </Grid>
            <Grid xs={4} >
                <Typography>Department</Typography>
                <TextField id="outlined-basic" label="Department" variant="outlined" value={department} />
            </Grid> 
            <Grid xs={4} >
                <Typography>Section</Typography>
                <TextField id="outlined-basic" label="Section" variant="outlined" value={section}/>
            </Grid> 
       </Grid>
