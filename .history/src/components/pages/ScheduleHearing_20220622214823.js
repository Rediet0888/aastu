    ...
    <Grid>
        <Paper elevation={20} style={schhear}>
            ...
            <Grid className='accuseid' xs={12}>
                ...
                <TextField id="outlined-basic" error={Boolean(accusationIdErrors?.accusationid)}  helperText={accusationIdErrors?.accusationid} variant="outlined" value={accusationid} onChange={handleAccusationIdChange} /> 
            </Grid>
            <Grid xs={6}>
                <Typography>
                    Description
