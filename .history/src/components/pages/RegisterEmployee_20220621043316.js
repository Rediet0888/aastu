        ...
        <Grid xs={12} className="regname">
          <Grid xs={4}>
            ...
            <TextField
              id="outlined-basic"
              label="FirstName"
              error={Boolean(firstNameErrors?.firstname)}
              helperText={firstNameErrors?.firstname}
              variant="outlined"
              value={firstname}
          ...
          <Grid xs={4}>
            ...
            <TextField
              id="outlined-basic"
              label="MiddleName"
              error={Boolean(middleNameErrors?.middlename)}
              helperText={middleNameErrors?.middlename}
              variant="outlined"
              value={middlename}
          ...
          <Grid xs={4}>
            ...
            <TextField
              id="outlined-basic"
              label="LastName"
              error={Boolean(lastNameErrors?.lastname)}
              helperText={lastNameErrors?.lastname}
              variant="outlined"
              value={lastname}
        ...
        <Grid xs={12} className="regemer">
          <Grid xs={6}>
            ...
            <TextField
              id="outlined-basic"
              label="FullName"
              error={Boolean(fullNameErrors?.fullname)}
              helperText={fullNameErrors?.fullname}
              variant="outlined"
              value={fullname}
          ...
          <Grid xs={6}>
            ...
            <TextField
              id="outlined-basic"
              label="PhoneNo"
              error={Boolean(phoneNoErrors?.phoneno)}
              helperText={phoneNoErrors?.phoneno}
              variant="outlined"
              value={phoneno}
