      ...
      <RadioGroup onChange={e => {
       ...
       <Divider variant="middle" />
            ...
            <Grid xs={4} >
                ...
                <TextField id="outlined-basic" label="Wereda" variant="outlined" value={wereda} />
            </Grid>
            <Grid xs={4} >
                <Typography>HouseNo</Typography>
                <TextField id="outlined-basic" label="HouseNo" variant="outlined" value={houseno}/>
                </Grid>
            </Grid>
       ...
       <Divider variant="middle" />
            ...
            <Grid xs={6} >
                <Typography>Phone Number</Typography>
                <TextField id="outlined-basic" label="Emergency Contact Phone Number" error={Boolean(phoneNoErrors?.phoneno)}  helperText={phoneNoErrors?.phoneno} variant="outlined" value={emergencyphoneno}  onChange ={handlePhoneNoChange}  />
            </Grid>   
            </Grid>
