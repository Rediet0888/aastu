      ...
      axios.post(baseURL,body,{
        ...
        if(res.data.message==="Authentication Successful"){
          ...
          if( res.data.role_type === "Student"){
            navigate('/Student')
          }else if(res.data.role_type === "Student-Admin"){
            navigate('components/pages/StudentAdminDashboard')
          }else if(res.data.role_type === "Admin" || res.data.role_type === "admin"){
            navigate('components/pages/Admin')
          }else if(res.data.role_type === "Employee-Admin"){
            navigate('components/pages/EmployeeAdminDashboard')
          }
