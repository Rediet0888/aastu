    ...
    <Grid>
       ...
       <Divider variant="middle" />
            ...
            <Grid xs={4} >
                ...
                <TextField type = "password"id="outlined-basic" label="Password" error={Boolean(passwordErrors?.password)}  helperText={passwordErrors?.password}  variant="outlined" value={password} onChange={handlePasswordChange} />
                </Grid>
                <Grid xs={6} >
      ...
      value={houseno}/>
       ...
       <Divider variant="middle" />
            ...
            <Grid xs={6} >
                <Typography>Phone Number</Typography>
                <TextField id="outlined-basic" label="Phone Number" error={Boolean(emergencyphoneNoErrors?.phoneno)}  helperText={emergencyphoneNoErrors?.phoneno} variant="outlined" value={emergencyphoneno}  onChange ={handleEmergencyPhoneNoChange}  />
            </Grid>   
            </Grid>
