       ...
       <TableBody>
         {rows.map((row) => (
           <TableRow key={row.number}>
             ...
             <TableCell><Button variant="contained" color="primary" ><EditIcon/></Button></TableCell>
             <TableCell><Button variant="contained" color="primary" ><DeleteOutlineIcon/></Button></TableCell>
